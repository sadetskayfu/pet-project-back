...
-- CreateTable
CREATE TABLE "ViewedMoviesByUser" (
    "id" SERIAL NOT NULL,
    "userId" INTEGER NOT NULL,
    "movieId" INTEGER NOT NULL,

    CONSTRAINT "ViewedMoviesByUser_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "WishListMovie" ADD CONSTRAINT "WishListMovie_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WishListMovie" ADD CONSTRAINT "WishListMovie_movieId_fkey" FOREIGN KEY ("movieId") REFERENCES "Movie"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
